                      ...
                      <form action="{{route('postProduct')}}" method="POST">
                         @csrf
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <!-- <input type="text" id="product_category_id" class="form-control" name="product_category_id" required autofocus>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="vendor_price" class="form-control" name="vendor_price" required autofocus>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="sale_price" class="form-control" name="sale_price" required autofocus>
