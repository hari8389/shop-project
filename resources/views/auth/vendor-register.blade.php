...
<main class="login-form">
  <div class="cotainer">
      <div class="row justify-content-center">
          <div class="col-md-8">
              <div class="card">
                  <div class="card-header">Vendor Register</div>
                  <div class="card-body">
                      ...
                      <form action="{{ route('vendor-post') }}" method="POST">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <textarea type="text" id="address" class="form-control" name="address" required>
                                  </textarea>
                              </div>
                          </div>
                          <div class="form-group row">
                              <div class="col-md-6">
                                  <input type="hidden" id="type" class="form-control" name="type" value="vendor" required>
                              </div>
                          </div>
