          ...
          <div class="col-md-8">
              <div class="card">
                  ...
                  <div class="card-body">
                      ...
                      <form action="{{route('purchase_updates',$product->id)}}"  method="POST" >
                         @csrf
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                              <div class="form-group mb-3">
                                  <input id="price-dd" name="price" class="form-control" value="{{ $product->price}}" type="text">
                                  </select> 
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" class="form-control" name="quantity" value="{{ $product->quantity}}" id="quantity_id" required >
