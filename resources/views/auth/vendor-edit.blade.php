              ...
              <div class="card">
                ...
                @csrf
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="address" onKeyPress class="form-control" name="address" autofocus required value="{{ $user->address}}">
                          ...
                          <div class="form-group row">
                              <div class="col-md-6">
                                  <input type="hidden" id="type" class="form-control" name="type" value="vendor" required value="{{ $user->type }}">
                              </div>
                          </div>
